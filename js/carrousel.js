...
document.getElementsByClassName("buscar")[0].onclick = function() {mostrarSlides()};


var slideIndice = 0;
function mostrarSlides() {
  var nums = ["screen.png", "blackson@2x.png", "reverse2@2x.png", "cluedo@2x.png", "nani2@2x.png", "watashi@2x.png", "pernalta@2x.png" ,"kimyona@2x.png"]
  var path = "";
